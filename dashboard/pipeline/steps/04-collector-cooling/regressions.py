...
""",
  ...
  switch (probe.outcome) {""",
    ...
    ("T68 the assembler reaches a shared budget through a DEEPER import specifier",
     ...
     # serves a source-text guard), but the ambiguity check added this run is a hard failure by
     # design, so the anchor is pinned to the value import's last specifier.
     [("  withServiceState,\n} from '@/lib/collectors';",
       "  withServiceState,\n} from '@/lib/collectors';\n"
